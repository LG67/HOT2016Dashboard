...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Camera Types.ctl" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Camera Types.ctl"/>
			<Item Name="FRC Color Processing Example.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/FRC Color Processing Example.vi"/>
			...
			<Item Name="Calibration Helper2.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Calibration Helper2.vi"/>
			<Item Name="Label Targets2.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Label Targets2.vi"/>
			<Item Name="Get camera FOVs.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Get camera FOVs.vi"/>
			<Item Name="Compute DistanceToTarget2.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Compute DistanceToTarget2.vi"/>
			<Item Name="Normalize Coordinates.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Normalize Coordinates.vi"/>
			<Item Name="Normalized Range Compare 2016.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Normalized Range Compare 2016.vi"/>
			<Item Name="Normalize Score.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Normalize Score.vi"/>
			<Item Name="Aspect Ratio Score 2016.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Aspect Ratio Score 2016.vi"/>
			<Item Name="Area Scoring.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Area Scoring.vi"/>
			<Item Name="Moment Score.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Moment Score.vi"/>
			<Item Name="Calculate Particle Scores.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Calculate Particle Scores.vi"/>
			<Item Name="Sorted Particle Report 2016.vi" Type="VI" URL="../Vision FRC Color Processing Example Folder - Copy/Vision Support Code/Sorted Particle Report 2016.vi"/>
